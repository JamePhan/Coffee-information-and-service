...
{
    public class ViewListFollowingShopCoffee_Test
    {
        private readonly Mock<CoffeehouseSystemContext> _mockContext;
        private readonly Mock<IMapper> _mockMapper;

        public ViewListFollowingShopCoffee_Test()
        {
        ...
        {
            Test_ViewListFollowingShopCoffee_Success(1);
        }

        [Fact]
        public void TC2_ViewListFollowingShopCoffee_Test()
        {
            Test_ViewListFollowingShopCoffee_Success(2);
        }

        [Fact]
        public void TC3_ViewListFollowingShopCoffee_Test()
        {
            Test_ViewListFollowingShopCoffee_Success(3);
        }

        [Fact]
        public void TC4_ViewListFollowingShopCoffee_Test()
        {
            Test_ViewListFollowingShopCoffee_Success(0);
        }

        [Fact]
        public void TC5_ViewListFollowingShopCoffee_Test()
        {
            Test_ViewListFollowingShopCoffee_Success(9);
        }

        [Fact]
        public void TC6_ViewListFollowingShopCoffee_Test()
        {
            Test_ViewListCustomerFollowing_Fail(1);
        }

        public void Test_ViewListFollowingShopCoffee_Success(int id)
        {
